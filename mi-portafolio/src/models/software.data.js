...
export const SOFTWARE_DATA = [
  // ── Carta de cumpleaños para una amiga ─────────────────────────────────
  {
    id: "cumpleanos-amiga",
    ...
    año: 2025,
    github:
      "https://github.com/Mau-Noj/portafolio/tree/master/mi-portafolio/src/apps/Cumplea%C3%B1osAmiga",
    ...
    demo: {
      youtube_id: "",
      descripcion: "App interactiva de cumpleaños con analizador léxico.",
    },
    stack: {
    ...
    descripcion:
      "Aplicación personal de cumpleaños con carta, momentos y regalo interactivo con analizador léxico de relación.",
      ...
      fases: [
        {
          fase: "inicio",
          completada: true,
          descripcion: "Concepto y estructura.",
        },
        {
          fase: "elaboracion",
          completada: true,
          descripcion: "Diseño visual púrpura festivo.",
        },
        {
          fase: "construccion",
          completada: true,
          descripcion: "Carta, momentos, regalo + analizador léxico.",
        },
        {
          fase: "transicion",
          completada: true,
          descripcion: "Integrado al portafolio.",
        },
      ],
    },
    requerimientos: {
      funcionales: [
        {
          id: "RF-001",
          nombre: "Carta animada",
          descripcion: "Carta con confetti y animación de entrada.",
          prioridad: "Alta",
          estado: "Implementado",
        },
        {
          id: "RF-002",
          nombre: "Galería de momentos",
          descripcion: "Grid de momentos especiales.",
          prioridad: "Alta",
          estado: "Implementado",
        },
        {
          id: "RF-003",
          nombre: "Regalo interactivo",
          descripcion: "Caja que se abre y revela mensaje.",
          prioridad: "Alta",
          estado: "Implementado",
        },
        {
          id: "RF-004",
          nombre: "Analizador léxico",
          descripcion:
            "Detecta tokens: amiga, esposa, amante → alerta personalizada.",
          prioridad: "Alta",
          estado: "Implementado",
        },
      ],
      no_funcionales: [
        {
          ...
          descripcion: "Funcional en móvil.",
          criterio: "Responsive desde 320px",
        },
      ],
    },
    trazabilidad: [
    ...
    arquitectura: {
      ...
      descripcion:
        "Frontend puro. Analizador léxico implementado en JavaScript puro sin ANTLR.",
      mermaid: "",
      imagen: "",
      decisiones: [],
    },
    arch_diagram: ARCH_CUMPLEANOS,
    patrones: [
      {
        nombre: "Analizador Léxico",
        categoria: "Compiler Pattern",
        uso: "Tokenización del input para detectar tipo de relación.",
      },
      {
        nombre: "Lazy Loading",
        categoria: "Performance",
        uso: "Cargado solo al navegar a la app.",
      },
    ],
    ciclo_vida: {
      ...
      hitos: [
        {
          fecha: "2025-03",
          fase: "Desarrollo",
          descripcion: "Implementación completa en un día.",
        },
      ],
    },
  },
